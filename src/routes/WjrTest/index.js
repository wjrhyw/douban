      ...
      <div>
        <Form className={SEARCH_FORM_CLASSNAME}>
          <Row {...SEARCH_FORM_ROW_LAYOUT}>
            <Col {...FORM_COL_4_LAYOUT}>{this.renderCodeFormItem()}</Col>
            <Col {...FORM_COL_4_LAYOUT}>{this.renderNameFormItem()}</Col>
            <Col {...FORM_COL_4_LAYOUT}>{this.renderDescriptionFormItem()}</Col>
          ...
          <Modal
            ...
            footer={[
              <Button onClick={this.handleCollectForm}>
          ...
          >
            <Row {...SEARCH_FORM_ROW_LAYOUT}>
              <Col>{this.renderCodeFormItem(MODAL_FORM_ITEM_LAYOUT)}</Col>
              <Col>{this.renderNameFormItem(MODAL_FORM_ITEM_LAYOUT)}</Col>
              <Col>{this.renderDescriptionFormItem(MODAL_FORM_ITEM_LAYOUT)}</Col>
              <Col>
                <Form.Item
                  {...MODAL_FORM_ITEM_LAYOUT}
        ...
        {this.props.list.map((item, index) => {
          return (
            <p key={index} style={{ color: 'blue', fontSize: '30px' }}>
